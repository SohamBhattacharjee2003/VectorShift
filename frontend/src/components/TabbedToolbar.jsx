...
const categories = {
  'VectorShift': [
    ...
    { type: 'boolean', label: 'Boolean', color: 'green', icon: '🔘' },
    { type: 'delay', label: 'Delay', color: 'green', icon: '⏳' },
    { type: 'merge', label: 'Merge', color: 'green', icon: '🔗' },
  ],
  'AI': [
    ...
    { type: 'llm', label: 'Mistral', color: 'blue', icon: '🌪️' },
    { type: 'llm', label: 'Llama', color: 'blue', icon: '🦙' },
    { type: 'llm', label: 'Gemini', color: 'blue', icon: '💎' },
    { type: 'llm', label: 'Custom LLM', color: 'blue', icon: '🛠️' },
  ],
  'Logic': [
    ...
    { type: 'switch', label: 'Switch', color: 'orange', icon: '🔀' },
    { type: 'split', label: 'Split', color: 'orange', icon: '🪓' },
    { type: 'compare', label: 'Compare', color: 'orange', icon: '⚖️' },
  ],
  'Data': [
  ...
  'Integrations': [
    ...
    { type: 'text', label: 'Slack', color: 'pink', icon: '💻' },
    { type: 'text', label: 'Google Drive', color: 'pink', icon: '🗃️' },
    { type: 'text', label: 'Notion', color: 'pink', icon: '📔' },
    { type: 'text', label: 'Zapier', color: 'pink', icon: '⚡' },
  ]
};
