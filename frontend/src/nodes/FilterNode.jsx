    ...
    >
      <div className="space-y-3">
        <label className="flex flex-col">
          ...
          <select
            className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all bg-white"
            value={condition}
        ...
        <label className="flex flex-col">
          ...
          <input
            className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all"
            type="text"
            value={value}
